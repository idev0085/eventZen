...
const SocialFacebook = ({
  ...
  >
    <G clipPath="url(#a)">
      ...
      <Path
        fill="#fff"
        d="m22.228 20.625.71-4.625H18.5v-3c0-1.266.619-2.5 2.606-2.5h2.019V6.562s-1.831-.312-3.581-.312c-3.657 0-6.044 2.216-6.044 6.225V16H9.437v4.625H13.5v11.181c.816.128 1.65.194 2.5.194.85 0 1.684-.066 2.5-.194V20.625h3.728Z"
      />
    </G>
    <Defs>
      <ClipPath id="a">
